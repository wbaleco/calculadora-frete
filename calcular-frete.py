...
def main(page: ft.Page):
    ...
    def calcular_distancia():
        try:
            ...
            # Atualizar o campo de distância
            ...
            txt_distancia.value = ""  # Limpa o campo em caso de erro
            page.update()
            return None

    def on_destino_change(e):
        if txt_origem.value and txt_destino.value:
            calcular_distancia()
